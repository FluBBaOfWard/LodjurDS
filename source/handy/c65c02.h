...
//
		case 0x00:
			gSystemCycleCount += (1+(6*AVE_RDWR_CYC));
			// IMPLIED
			xBRK();
			break;
		case 0x01:
			gSystemCycleCount += (1+(5*AVE_RDWR_CYC));
			xINDIRECT_X();
			xORA();
			break;
		case 0x02:
			gSystemCycleCount += (1+(1*AVE_RDWR_CYC));
			// *** ILLEGAL ***
			xILLEGAL();
			break;
		case 0x03:
			...
			break;
		case 0x04:
			gSystemCycleCount += (1+(4*AVE_RDWR_CYC));
			xZEROPAGE();
			xTSB();
			break;
		case 0x05:
			gSystemCycleCount += (1+(2*AVE_RDWR_CYC));
			xZEROPAGE();
			xORA();
			break;
		case 0x06:
		...
		case 0x0C:
			...
			break;
		case 0x0D:
			gSystemCycleCount+=(1+(3*AVE_RDWR_CYC));
			xABSOLUTE();
			xORA();
			break;
		case 0x0E:
...
//
		...
		case 0x5B:
			...
			break;
		case 0x5C:
			gSystemCycleCount+=(1+(7*AVE_RDWR_CYC));
			// *** ILLEGAL ***
			xILLEGAL();
			break;
		case 0x5D:
