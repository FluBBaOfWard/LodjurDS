...
GAME_TITLE	:= LodjurDS
GAME_SUBTITLE	:= Lynx Emulator
GAME_AUTHOR	:= github.com/FluBBaOfWard
GAME_ICON	:= LynxLogo.png
...
DEFINES		:=	-DARM9 -DNDS -DR65C02 -DPICOLIBC_LONG_LONG_PRINTF_SCANF
...
CFLAGS		+= $(WARNFLAGS) $(INCLUDEFLAGS) $(DEFINES) \
		   $(ARCH) -O3 -ffunction-sections -fdata-sections \
		   -specs=$(SPECS)
